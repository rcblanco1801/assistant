...
Cabe recordar que es necesario para que nginx sirva el frontend que exista un enlace simbólico a la configuración en el fichero ```chat``` en ```/etc/nginx/sites-enabled```; asimismo, ```index.html``` tiene que estar en ```/var/www/chat```.
